...
import { useVendorServices, useUpdateService } from '@/lib/hooks/use-vendor-services';
import type { Service } from '@/lib/hooks/use-vendor-services';
    ...
    useEffect(() => {
        if (service) {
            reset({
                ...
                price_min: service.price_min != null ? String(service.price_min) : '',
